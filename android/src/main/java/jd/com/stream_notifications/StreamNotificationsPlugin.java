...
/** StreamNotificationsPlugin */
public class StreamNotificationsPlugin implements EventChannel.StreamHandler {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    StreamNotificationsPlugin plugin = new StreamNotificationsPlugin(context);
   ...
   */
  private StreamNotificationsPlugin(Context context) {
